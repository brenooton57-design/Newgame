...
define gui.accent_color = '#d63031'

## The color used for a text button when it is neither selected nor hovered.
define gui.idle_color = '#b8b8b8'

## The small color is used for small text, which needs to be brighter/darker to
## achieve the same effect.
define gui.idle_small_color = '#c9c9c9'
...
define gui.muted_color = '#5a0000'
define gui.hover_muted_color = '#8a0000'
...
define gui.text_font = "fonts/Nunito.ttf"

## The font used for character names.
define gui.name_text_font = "fonts/Nunito.ttf"

## The font used for out-of-game text.
define gui.interface_text_font = "fonts/Nunito.ttf"
...
define gui.choice_button_borders = Borders(45, 25, 45, 25)
...
define gui.pref_spacing = 18

## Controls the amount of spacing between preference buttons.
define gui.pref_button_spacing = 3

## The spacing between file page buttons.
define gui.page_spacing = 3

## The spacing between file slots.
define gui.slot_spacing = 18
...
style choice_button:
    padding (30, 20, 30, 20)
    background Transform("#1a1a1a", alpha=0.85)
    hover_background Transform("#d63031", alpha=0.95)
    selected_background Transform("#d63031", alpha=1.0)
    xalign 0.5
    xmaximum 900
    yminimum 90
...
style action_button:
    padding (25, 18, 25, 18)
    background Transform("#2d3436", alpha=0.9)
    hover_background Transform("#ff6b6b", alpha=0.95)
    xalign 0.5
    xmaximum 700
    yminimum 75
...
style cum_button:
    padding (35, 22, 35, 22)
    background Transform("#8B0000", alpha=0.9)
    hover_background Transform("#FF0000", alpha=1.0)
    xmaximum 250
    yminimum 95

style cum_button_text:
    font gui.text_font
    size 48
    color "#FFFFFF"
    hover_color "#FFFFFF"
    outlines [(4, "#ff3b3b", 0, 0), (2, "#000000", 2, 2)]
    text_align 0.5
    xalign 0.5
    yalign 0.5
    bold True
