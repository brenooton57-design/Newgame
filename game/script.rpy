...
image m1video = Movie(play="images/m1.webm", loop=True)
image m2video = Movie(play="images/m2.webm", loop=True)
image m3video = Movie(play="images/m3.webm", loop=True)
image m4video = Movie(play="images/m4.webm", loop=True)
image banheirovideo1 = Movie(play="images/banheirovideo1.webm", loop=True)
image banheirovideo2 = Movie(play="images/banheirovideo2.webm", loop=True)
...
label camila_perspective:
    ...
    scene black with fade
    show banheirovideo1 at zzoom176
    play sound "audio/chupandosom.mp3" loop fadein 0.2
...
label blowjob_loop:
    scene black with fade
    show banheirovideo2 at zzoom176
    play sound "audio/chupandosom.mp3" loop fadein 0.2
...
label husband_perspective:
    ...
    scene black with fade
    show m1video at zzoom176
    play music "audio/chupandosom.mp3" loop fadein 0.2 volume 0.3
...
label bathroom_closer_look_1:
    scene black with fade
    stop music
    play music "audio/chupandosom.mp3" loop fadein 0.2 volume 0.5
    show m2video at zzoom176
    "{i}Let me get a closer look...{/i}"
    "{i}What the hell...{/i}"
    "{i}Wait... is that...?{/i}"
    "{i}That dress looks familiar...{/i}"
    "{i}No... probably just a coincidence...{/i}"
    "{i}But... that shade of white...{/i}"
    "{i}And those shoes... I've seen those before...{/i}"
    "{i}Hold on... that can't be...{/i}"
    "{i}Is that... a wedding ring?{/i}"
    "{i}On her left hand...{/i}"
    "{i}It's catching the light... just like...{/i}"
    "{i}No, stop. You're being paranoid...{/i}"
    "{i}Lots of people get married today...{/i}"
    "{i}But... something about her posture...{/i}"
    "{i}The way she's standing...{/i}"
    "{i}That bracelet on her wrist...{/i}"
    "{i}I gave Camila a bracelet like that...{/i}"
    "{i}Okay, this is too many coincidences...{/i}"
    "{i}I need to see her face...{/i}"
    "{i}Just to be sure...{/i}"
    "{i}Please don't let it be her...{/i}"

    jump bathroom_closer_look_1
...
label bathroom_closer_look_2:
    scene black with fade
    show m4video at zzoom176
    stop music
    play music "audio/chupandosom.mp3" loop fadein 0.2 volume 0.7
    "{i}Oh... things are escalating now...{/i}"
    "{i}He's holding her head...{/i}"
    "{i}Guiding her movements...{/i}"
    "{i}Jesus... he's huge...{/i}"
    "{i}How is she even...{/i}"
    "{i}He's pushing it deeper...{/i}"
    "{i}That's... that's a lot...{/i}"
    "{i}She's struggling to take it all...{/i}"
    "{i}But she's not stopping...{/i}"
    "{i}He's really controlling the pace now...{/i}"
    "{i}Fuck... that size...{/i}"
    "{i}I'm nowhere near that big...{/i}"
    "{i}She seems... determined...{/i}"
    "{i}Even with him being so rough...{/i}"    

    jump bathroom_closer_look_2
